...
namespace RegistryClassApi
{
	...
	public class clsRegistry
	{
        ...
        public float GetFloatValue(RegistryKey hiveKey, string strSubKey, string dwValue)
        {
            object objData = null;
            RegistryKey subKey = null;
            ...
            strRegError = null;
            return float.Parse(objData.ToString());
        }
        ...
        public double GetDoubleValue(RegistryKey hiveKey, string strSubKey, string dwValue)
        {
            object objData = null;
            RegistryKey subKey = null;
            ...
            strRegError = null;
            return double.Parse(objData.ToString());
        }
        ...
        public void SetDoubleValue(RegistryKey hiveKey, string strSubKey, string strValue, double dwData)
        {
            RegistryKey subKey = null;
